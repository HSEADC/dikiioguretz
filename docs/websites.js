...
var token = 'patEG59q9n6nmP5cv.1c7f4c3308ec509316416a3206ffda0e300d653b9d39c0a03f00fa7d5c6369c1';
airtable__WEBPACK_IMPORTED_MODULE_0___default().configure({
  endpointUrl: 'https://api.airtable.com',
  apiKey: token
});
var base = airtable__WEBPACK_IMPORTED_MODULE_0___default().base('appZUmWgFDWGxVoDr');
var data;
getWebsitesTeasers().then(function (content) {
  data = content;
  updateInfo(data);
});
